...
(function() {
    ...
    h.prototype._step = function(n) {
        ...
        n = n - this._pauseTime;
        var m = (n - b) / this._opts.duration;
        var l = Math.round(this._expandPath.length * m);
        this._polyline.setPath(this._expandPath.slice(0, l));
        if (n < b + this._opts.duration) {
