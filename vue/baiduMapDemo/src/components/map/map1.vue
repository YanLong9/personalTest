...
export default {
  ...
  methods: {
    initMap() {
      ...
      var point = new BMapGL.Point(112.164779, 37.212845); // 创建点坐标
      ...
      var data = [
        {
          geometry: {
            type: 'Point',
            coordinates: [119.95629, 30.275156]
          }
        }
      ];
    ...
    carLayer() {
      ...
      console.log(carlineLayer);
      this.view.addLayer(carlineLayer);
      carlineLayer.setData(this.data);

      setTimeout(() => {
        console.log(1);
        carlineLayer.options.step = 10;
      }, 5000);

      // this.map.setDefaultCursor('default');

      // var coordinates = this.data[0].geometry.coordinates;
      // var point = [];
